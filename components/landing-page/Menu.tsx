...
const solutions = [
  ...
  },
  {
    ...
    href: 'https://www.roxie.ai/products/crisp-plugin',
    icon: (props: any) => (
      <img
        {...props}
  ...
  },
  {
    ...
    href: 'https://www.roxie.ai/products/slack-bot',
    icon: (props: any) => (
      <img
        {...props}
  ...
  },
  {
    ...
    href: 'https://docs.roxie.ai/introduction',
    icon: ServerIcon,
  },
  {
    name: 'On Premise',
    description: 'Install Roxie on your own infrastructure',
    href: 'https://github.com/voyagersocial/roxiedoxy',
    icon: CpuChipIcon,
  },
];
const callsToAction = [
