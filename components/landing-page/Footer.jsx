      ...
      <Container>
        <div className="flex flex-col justify-center py-16">
          ...
          <nav className="mt-10 text-sm" aria-label="quick links">
            ...
            {/* <Link href={RouteNames.CHAT_SITE}>
              ...
              <NavLink href="https://github.com/voyagersocial/roxiedoxy" target={"_blank"}>GitHub</NavLink>
              <NavLink href="https://docs.roxie.ai/" target={"_blank"}>Docs</NavLink>
        ...
        <div className="flex flex-col items-center py-10 border-t border-white/20 sm:flex-row-reverse sm:justify-between">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Roxie. All rights
            reserved.
          </p>
        </div>
      </Container>
