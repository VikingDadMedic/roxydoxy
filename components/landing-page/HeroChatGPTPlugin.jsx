      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col space-y-8 text-center sm:space-y-0 sm:flex-row sm:space-x-8 sm:text-left">
          ...
          >
            ...
            {/* <a
          href="https://www.producthunt.com/posts/roxie-ai?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-roxie&#0045;ai"
          target="_blank"
        >
          <img
            src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=394302&theme=light"
            alt="Roxie&#0046;ai - Build&#0032;a&#0032;ChatGPT&#0032;plugin&#0032;in&#0032;minutes | Product Hunt"
            style={{
              width: '250px',
              height: '54px',
              marginLeft: 'auto',
          ...
          />
            ...
            <Stack
              ...
              className="justify-center sm:justify-start"
            >
              <Link target="_blank" href={'https://app.roxie.ai/signin'}>
                <Button
                  variant="solid"
                  size="lg"
              ...
              <Link
                target="_blank"
                href={'https://calendly.com/roxie-georges/15min'}
              >
                <Button
                  variant="outlined"
                  size="lg"
          ...
          <div className="w-full sm:w-2/3">
            ...
            <iframe
              src="https://app.roxie.ai/agents/clgtujkqh022j0u0zw3ut8vk3/iframe"
              width="100%"
              height="100%"
              frameBorder="0"
              ></iframe>
        ...
        <div className="flex justify-center mt-10 gap-x-6">
          {/* <Button target="_blank" href="https://app.roxie.ai/signin">Start Building</Button> */}
          {/* <Button
