      ...
      <Transition.Root>
        ...
        >
          ...
          >
            ...
            <MobileNavLink href="https://github.com/voyagersocial/roxiedoxy" target={'_blank'}>
              GitHub
            </MobileNavLink>
            <MobileNavLink href="https://docs.roxie.ai/" target={'_blank'}>
              Docs
            </MobileNavLink>
            <MobileNavLink href="https://roxie.getrewardful.com/" target={'_blank'}>
              Affiliates
            </MobileNavLink>
            {/* <MobileNavLink href="#testimonials">Testimonials</MobileNavLink> */}
            {/* <MobileNavLink href="#pricing">Pricing</MobileNavLink> */}
            <hr className="m-2 border-slate-300/40" />
            <MobileNavLink href="https://app.roxie.ai">
              Sign in
            </MobileNavLink>
          </Popover.Panel>
        </Transition.Child>
...
<Menu />
              ...
              <NavLink href="https://github.com/voyagersocial/roxiedoxy" target={'_blank'}>
                GitHub
              </NavLink>
              <NavLink href="https://docs.roxie.ai/" target={'_blank'}>
                Docs
              </NavLink>
              <NavLink href="https://roxie.getrewardful.com/" target={"_blank"}>
                Affiliates
              </NavLink>
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            {/* <div className="hidden md:block">
              <NavLink href="https://app.roxie.ai">Sign in</NavLink>
            </div> */}
            {/* <Button target="_blank" href="https://app.roxie.ai/signin" color="blue">
              <span>
                Sign In
              </span>
            </Button> */}
            {/* Change following link href with /signin for local signin */}
            <Link href="https://app.roxie.ai/signin">
