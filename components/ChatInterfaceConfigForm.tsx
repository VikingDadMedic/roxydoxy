...
function ChatInterfaceConfigForm({ agentId }: Props) {
                    ...
                    <CacheProvider value={cache}>
                      <ThemeProvider theme={theme}>
                        <CssVarsProvider
                          theme={theme}
                          defaultMode="light"
                          modeStorageKey="roxie-chat-bubble"
                        >
                          <CssBaseline />
                          <Box
                            sx={{
  ...
  src="https://cdn.jsdelivr.net/npm/@voyagersocial/chat-bubble@latest"
></script>`}
          </SyntaxHighlighter>
        </Stack>
      </Stack>
                  ...
                  <CacheProvider value={cache}>
                    <ThemeProvider theme={theme}>
                      <CssVarsProvider
                        theme={theme}
                        defaultMode="light"
                        modeStorageKey="roxie-chat-iframe"
                      >
      ...
      <Stack id="embed" gap={2} mt={4} mb={2}>
        ...
        >
          {`<iframe
  src="https://app.roxie.ai/agents/${getAgentQuery?.data?.id}/iframe"
  width="100%"
  height="100%"
  frameborder="0"
></iframe>
