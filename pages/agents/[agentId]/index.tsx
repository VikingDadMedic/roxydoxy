...
export default function AgentPage(props: InferGetServerSidePropsType<typeof getServerSideProps>) {
                ...
                <List variant="outlined" sx={{ mt: 2 }}>
                  {[
                    ...
                    },
                    {
                      ...
                      action: () => {
                        window.open(
                          'https://zapier.com/apps/roxie/integrations',
                          '_blank'
                        );
                      },
                    },
              ...
              <>
                ...
                <FormControl sx={{ gap: 1 }}>
                  ...
                  <Typography level="body3" mb={2}>
                    Use the Agent ID to query the agent through Roxie API
                  </Typography>
                  <Stack spacing={2}>
                    <Alert
                      color="info"
                      ...
                      endDecorator={
                        <Link href="https://docs.roxie.ai" target="_blank">
                          <Button
                            variant="plain"
                            size="sm"
                    ...
                    >
                      Learn more about the Roxie API
                    </Alert>
