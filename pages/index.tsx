...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Roxie - Build ChatGPT Agents trained on your custom data
        </title>

        <meta
          name="title"
          content="Roxie - Build ChatGPT Agents trained on your custom data"
        />
        <meta
          name="description"
          content="Roxie offers a no-code platform to create custom AI chatbots trained on your data. Our solution streamlines customer support, onboards new team members, and simplifies your team's workflow."
        />
        <meta
          name="keywords"
          content="AI chatbot, No-code platform, Customer support, Onboarding, Slack AI chatbot, Automation, Roxie, ChatGPT Plugin"
        />
        <meta
          property="og:title"
          content="Roxie - Build ChatGPT Agents trained on your custom data"
        ...
        />
        <meta property="og:url" content="https://www.roxie.ai/" />
      ...
      <script
        defer
        src="https://cdn.jsdelivr.net/npm/@roxie/chat-bubble@1.0.20"
