...
export default function CrispConfig(props: InferGetServerSidePropsType<typeof getServerSideProps>) {
  ...
  return (
    <>
      <Head>
        <title>Roxie - Crisp Widget</title>
        <meta
          name="description"
          content="Roxie is the leading document retrievial platform"
        />
      </Head>
      <Box
        p={0}
      ...
      >
        {props.isPremium ? (
          ...
          <Alert color="warning" sx={{ m: 2 }}>
            This feature is restricted to Roxie.ai premium users
          </Alert>
        )}
      </Box>
    </>
