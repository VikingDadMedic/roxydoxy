...
export default function CrispConfig(props: { agent: Agent }) {
  ...
  return (
    <>
      <Head>
        <title>Roxie - LLMs automation without code</title>
        <meta
          name="description"
          ...
          <Card variant="outlined">
            ...
            <form className="flex flex-col">
              <Stack spacing={2}>
                {!user && (
                  <FormControl>
                    <FormLabel>Roxie API Key</FormLabel>
                    <Alert variant="outlined" sx={{ mb: 2 }}>
                      <Stack>
                        You can find your API Key in your Roxie{' '}
                        <Link
                    ...
                    <Input
                      value={inputValue}
                      placeholder="Your Roxie API Key here"
