...
export default function Home() {
  return (
    <>
      <Head>
        <title>Roxie - Crisp Plugin</title>
        <meta name="title" content="Roxie - Crisp Plugin" />
        {}
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Roxie, Crisp Plugin, AI chatbot, automatic data synchronization, custom data training, fast chatbot training, easy chatbot setup"
        />
      </Head>
      <Header />
