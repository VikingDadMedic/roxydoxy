...
export default function Home() {
  return (
    <>
      <Head>
        <title>Roxie - Slack Bot</title>

        <meta
          name="title"
          content="Slack Bot by Roxie - Train a Chatbot on Your Company Data"
        />
        <meta
          name="description"
          content="Roxie's Slack Bot makes it easy to train a chatbot on your company data. Just paste your website URL, we process your data and train your bot quickly. The bot is kept up-to-date with your data automatically. Other data sources like PDF, Gdoc, Sheets, Notion, Airtable, and more are also supported."
        />
        <meta
          name="keywords"
          content="Roxie, Slack Bot, AI chatbot, company data, chatbot training, automatic data sync, Slack plugin"
        />
      </Head>
      <Header />
...
const features = [
  ...
  },
  {
    ...
    description:
      'The final step is to install Roxie Bot to your Slack workspace. \nNow your workspace is spiced up \nwith some AI magic ✨',
      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        <div className="max-w-2xl mx-auto lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-400">
            SlackBot by Roxie, make it very easy to train a chatbot on your
            company data.
          </p>
        </div>
