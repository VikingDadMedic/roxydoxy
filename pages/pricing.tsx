...
export default function Pricing() {
  return (
    <>
      <Head>
        <title>Roxie Pricing - Plans for Teams of All Sizes</title>

        <meta
          name="title"
          content="Roxie Pricing - Plans for Teams of All Sizes"
        />
        <meta
          name="description"
          content="Choose an affordable plan with Roxie. Our offerings include Discover, Startup, Pro, and Enterprise levels, each packed with features for engaging your audience, creating customer loyalty, and driving sales."
        />
        <meta
          name="keywords"
          content="Roxie, Pricing, Data Processing, AI, Agents, Datastores, Queries, File Upload, Data Synching, API, ChatGPT Plugin, Slack Bot, Crisp Plugin, Website Loader"
        />
...
const tiers = [
  {
    name: 'Discover',
    id: 'tier-free',
    href: 'https://app.roxie.ai/account',
