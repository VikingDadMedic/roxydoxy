...
//     user: {
//       type: 'participant',
//       nickname: agentName || 'Roxie.ai',
//       avatar: 'https://roxie.ai/roxie-rounded-bg-white.png',
//     },

//     content: {
//       id: `roxie-query-${cuid()}`,
//       text: `✨ Ask ${agentName || `Roxie.ai`}`,
//       explain: 'Query',
//       value,
//     },
//   });
...
const handleQuery = async (
  ...
  try {
    ...
    //     user: {
    //       type: 'participant',
    //       nickname: agent?.name || 'Roxie.ai',
    //       avatar:
    //         agent.iconUrl ||
    //         'https://roxie.ai/roxie-rounded-bg-white.png',
    //     },
    //   }
    // );
  }
  ...
  await CrispClient.website.sendMessageInConversation(websiteId, sessionId, {
    ...
    user: {
      ...
      nickname: agent?.name || 'Roxie.ai',
      avatar:
        agent.iconUrl || 'https://roxie.ai/roxie-rounded-bg-white.png',
    },
  });
